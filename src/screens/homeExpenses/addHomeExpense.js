...
export default function AddHomeExpense() {
    ...
    return (
        <BaseView space>
            ...
            <Header
                back
                label={editData?.name ? strings.update : strings.add_expense}
            />
            <ScrollView
                style={styles.form}
                ...
                <DropdownPicker
                    ...
                    labelField="name"
                    valueField="name"
                    searchPlaceholder="Search Or Enter New"
                    placeholder={'Select category'}
                    value={'isPublic'}
                    onChange={value => {
                        onChangeValue({ setData, key: 'isPublic', value: value?.name });
                    }}
                />
                <Input
                    label={strings.name}
