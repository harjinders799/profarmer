...
import { ScrollView, Image, StyleSheet, BackHandler, Alert, View } from 'react-native'
...
GoogleSignin.configure({
    webClientId: "416058833468-5rn56d49jdg3ar3e0mp2o4e5nio1o65g.apps.googleusercontent.com"
});
    ...
    const handleOtp = (code) => {
        if (code.length == 6) {
            try {
                ...
                Auth().signInWithCredential(phoneCredentials)
                ...
                <Input
                    ...
                    leftComponent={
                        <View style={styles.row}>
                            <Icon name="phone" type="Feather" color={colors.primary} size={20} />
                            <Text h3 pl={10}>+91</Text>
                        </View>
                    }
