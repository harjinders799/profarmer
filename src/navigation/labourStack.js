...
export default function LabourStack() {
    return (
        <Stack.Navigator>
            ...
            <Stack.Screen name="AddLabour" component={AddLabour} options={{ headerShown: false }} />
            <Stack.Screen name="AddLabourExpense" component={AddLabourExpense} options={{ headerShown: false }} />
            <Stack.Screen name="AddLabourLeave" component={AddLabourLeave} options={{ headerShown: false }} />
            <Stack.Screen name="LabourDetail" component={LabourDetail} options={{ headerShown: false }} />
            <Stack.Screen name="RegularLabourDetail" component={RegularLabourDetail} options={{ headerShown: false }} />
        </Stack.Navigator>
    )
}
