...
import AddLand from '@screens/cropTracker/addLand';
import LandDetail from '@screens/cropTracker/landDetail';
import AddLandEvent from '@screens/cropTracker/addLandEvent';
...
export default function CropStack() {
  return (
    ...
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="AddLandEvent" component={AddLandEvent} />
