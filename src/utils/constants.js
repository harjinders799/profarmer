...
export const Collections = {
  ...
  lands_data: {name: 'lands_data', subCollections: []},
  picker_group: {name: 'picker_group', subCollections: []},
  picker_groups: {name: 'picker_groups', subCollections: []},
  ...
  interest_amount: {name: 'interest_amount', subCollections: []},
};
