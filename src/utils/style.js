...
export const commonStyle = StyleSheet.create({
    ...
    row_c_j_b: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%' },
    row_c_j_l: { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', width: '100%' },
